...
int main()
{
    ...
    is_example = false;
    runOn<[]() { solveSecond(); }>(std::format("{}1.in.txt", secondPartName));
    runOn<[]() { solveSecond(); }>(std::format("{}2.in.txt", secondPartName));
    runOn<[]() { solveSecond(); }>(std::format("{}3.in.txt", secondPartName));
